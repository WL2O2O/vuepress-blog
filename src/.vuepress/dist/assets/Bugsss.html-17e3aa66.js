...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这样，您告诉 Spring Boot 应用程序使用响应式的 Web 应用类型。同时，请注意，您需要相应地更新您的应用程序代码，以使用 WebFlux 相关的基础设施和 API，例如使用 <code>@Controller</code> 替换 <code>@ControllerAdvice</code>，并使用 <code>ServerWebExchange</code> 对象访问 HTTP 请求和响应1。</p></blockquote>`,42),s=[d];function a(r,c){return n(),i("div",null,s)}const v=e(l,[["render",a],["__file","Bugsss.html.vue"]]);export{v as default};
