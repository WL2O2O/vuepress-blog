import{_ as i,X as t,Y as c,$ as n,a2 as s,a0 as e,Z as l,C as p}from"./framework-8bd09bfb.js";const o={},u=n("h1",{id:"常用-git-命令清单",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#常用-git-命令清单","aria-hidden":"true"},"#"),s(" 常用 Git 命令清单")],-1),d={href:"http://www.ruanyifeng.com/",target:"_blank",rel:"noopener noreferrer"},r={href:"http://www.ruanyifeng.com/blog/2015/12/",target:"_blank",rel:"noopener noreferrer"},m=l(`<p>我每天使用 Git ，但是很多命令记不住。</p><p>一般来说，日常使用只要记住下图6个命令，就可以了。但是熟练使用，恐怕要记住60～100个命令。</p><figure><img src="http://www.ruanyifeng.com/blogimg/asset/2015/bg2015120901.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>下面是我整理的常用 Git 命令清单。几个专用名词的译名如下。</p><blockquote><ul><li>Workspace：工作区</li><li>Index / Stage：暂存区</li><li>Repository：仓库区（或本地仓库）</li><li>Remote：远程仓库</li></ul></blockquote><h2 id="一、新建代码库" tabindex="-1"><a class="header-anchor" href="#一、新建代码库" aria-hidden="true">#</a> 一、新建代码库</h2><blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 在当前目录新建一个Git代码库</span>
